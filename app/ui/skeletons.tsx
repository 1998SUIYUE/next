...
export function EditFormSkeleton() {
  return (
    <div
      className={`${shimmer} relative overflow-hidden rounded-md bg-gray-100 p-4 shadow-sm`}
    >
...
export function DebtsCreateFormSkeleton() {
  return (
...
export function ConsumTableSkeleton() {
  return (
    <div>
